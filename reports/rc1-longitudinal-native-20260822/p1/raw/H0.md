...
|---|---|---|---|---|---|---|---|
| tiny_04_arr | 7 | 10,000 | 757.41 ns | 617.56 ns | 426.63 ns | 16.44 µs (26.62x slower) | 20.74 µs (33.59x slower) |
| tiny_03_pair | 7 | 10,000 | 409.79 ns | 243.66 ns | 273.36 ns | 9.32 µs (38.26x slower) | 8.58 µs (35.20x slower) |
| tiny_02_empty_arr | 2 | 10,000 | 301.37 ns | 223.79 ns | 229.53 ns | 5.93 µs (26.48x slower) | 6.80 µs (30.41x slower) |
| tiny_05_string | 7 | 10,000 | 272.77 ns | 227.55 ns | 199.03 ns | 5.38 µs (23.62x slower) | 4.93 µs (21.66x slower) |
| tiny_06_bool_null | 17 | 10,000 | 423.66 ns | 237.47 ns | 217.22 ns | 18.47 µs (77.77x slower) | 17.73 µs (74.65x slower) |
| tiny_01_empty_obj | 2 | 10,000 | 275.80 ns | 223.88 ns | 230.61 ns | 6.37 µs (28.43x slower) | 5.61 µs (25.06x slower) |
...
|---|---|---|
| S3-O0-NATIVE | 1,196,312 | 1,188,041 |
| S3-O1-NATIVE | 1,180,440 | 1,172,040 |
...
- **OBSERVED**: S3 O0 generates 52883 instructions (74556 assembly lines) vs S3 O1 generating 52196 instructions (73575 assembly lines).
- **OBSERVED**: S3 O1 contains 9703 stack-related operations vs 9786 in S3 O0.
