...
- **S3 Compiler Commit**: `5dd6844607ba3a2d5830ed836fb9026eed86d0fb`
...
|---|---|---|---|---|---|---|---|
| tiny_04_arr | 7 | 10,000 | 249.30 ns | 131.67 ns | 131.29 ns | 9.79 µs (74.35x slower) | 9.71 µs (73.73x slower) |
| tiny_03_pair | 7 | 10,000 | 212.07 ns | 125.71 ns | 117.32 ns | 7.29 µs (57.96x slower) | 7.31 µs (58.16x slower) |
| tiny_02_empty_arr | 2 | 10,000 | 131.11 ns | 111.98 ns | 109.76 ns | 4.60 µs (41.07x slower) | 4.26 µs (38.07x slower) |
| tiny_05_string | 7 | 10,000 | 190.00 ns | 118.78 ns | 128.76 ns | 4.75 µs (40.00x slower) | 4.63 µs (39.02x slower) |
| tiny_06_bool_null | 17 | 10,000 | 307.68 ns | 202.68 ns | 138.39 ns | 14.52 µs (71.66x slower) | 14.21 µs (70.13x slower) |
| tiny_01_empty_obj | 2 | 10,000 | 158.79 ns | 131.80 ns | 140.14 ns | 4.69 µs (35.55x slower) | 4.76 µs (36.08x slower) |
...
|---|---|---|
| S3-O0-NATIVE | 1,153,024 | 1,144,517 |
| S3-O1-NATIVE | 1,137,144 | 1,128,655 |
...
- **OBSERVED**: S3 O0 generates 49188 instructions (70467 assembly lines) vs S3 O1 generating 48504 instructions (69489 assembly lines).
- **OBSERVED**: S3 O1 contains 7345 stack-related operations vs 7394 in S3 O0.
