...
- **S3 Compiler Commit**: `e23b092bec100cedc520841a7dd0f4488090b6a1`
...
|---|---|---|---|---|---|---|---|
| tiny_04_arr | 7 | 10,000 | 256.31 ns | 126.72 ns | 124.27 ns | 9.84 µs (77.62x slower) | 9.66 µs (76.25x slower) |
| tiny_03_pair | 7 | 10,000 | 238.16 ns | 125.65 ns | 116.43 ns | 7.29 µs (58.03x slower) | 7.09 µs (56.40x slower) |
| tiny_02_empty_arr | 2 | 10,000 | 122.64 ns | 103.15 ns | 104.62 ns | 4.27 µs (41.35x slower) | 4.20 µs (40.74x slower) |
| tiny_05_string | 7 | 10,000 | 153.14 ns | 115.40 ns | 104.10 ns | 4.36 µs (37.77x slower) | 4.15 µs (36.00x slower) |
| tiny_06_bool_null | 17 | 10,000 | 308.20 ns | 178.77 ns | 138.36 ns | 13.13 µs (73.45x slower) | 13.03 µs (72.89x slower) |
| tiny_01_empty_obj | 2 | 10,000 | 125.57 ns | 104.30 ns | 102.51 ns | 4.30 µs (41.22x slower) | 4.22 µs (40.48x slower) |
