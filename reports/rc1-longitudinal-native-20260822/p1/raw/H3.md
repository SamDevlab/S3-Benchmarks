...
- **S3 Compiler Commit**: `2316300f7f6c119004009b713849cae1c101d1a5`
...
|---|---|---|---|---|---|---|---|
| tiny_04_arr | 7 | 10,000 | 293.03 ns | 200.61 ns | 140.74 ns | 9.73 µs (48.48x slower) | 9.61 µs (47.91x slower) |
| tiny_03_pair | 7 | 10,000 | 211.20 ns | 119.55 ns | 117.50 ns | 7.36 µs (61.56x slower) | 7.18 µs (60.10x slower) |
| tiny_02_empty_arr | 2 | 10,000 | 130.78 ns | 103.37 ns | 100.69 ns | 4.22 µs (40.83x slower) | 4.33 µs (41.87x slower) |
| tiny_05_string | 7 | 10,000 | 164.13 ns | 114.22 ns | 119.08 ns | 4.72 µs (41.35x slower) | 4.27 µs (37.41x slower) |
| tiny_06_bool_null | 17 | 10,000 | 302.32 ns | 146.66 ns | 137.64 ns | 13.12 µs (89.47x slower) | 13.03 µs (88.82x slower) |
| tiny_01_empty_obj | 2 | 10,000 | 127.50 ns | 104.75 ns | 102.33 ns | 4.28 µs (40.90x slower) | 4.21 µs (40.15x slower) |
