...
- **S3 Compiler Commit**: `a9e430551f2ee77aa2ef229daf9e967333e83e2c`
...
|---|---|---|---|---|---|---|---|
| tiny_04_arr | 7 | 10,000 | 249.61 ns | 133.48 ns | 126.09 ns | 9.36 µs (70.09x slower) | 9.17 µs (68.73x slower) |
| tiny_03_pair | 7 | 10,000 | 218.50 ns | 130.53 ns | 128.62 ns | 6.93 µs (53.07x slower) | 6.78 µs (51.97x slower) |
| tiny_02_empty_arr | 2 | 10,000 | 132.50 ns | 111.36 ns | 114.10 ns | 4.05 µs (36.39x slower) | 3.95 µs (35.49x slower) |
| tiny_05_string | 7 | 10,000 | 154.04 ns | 121.99 ns | 111.68 ns | 4.11 µs (33.69x slower) | 4.08 µs (33.46x slower) |
| tiny_06_bool_null | 17 | 10,000 | 292.40 ns | 162.11 ns | 149.06 ns | 12.51 µs (77.16x slower) | 12.43 µs (76.69x slower) |
| tiny_01_empty_obj | 2 | 10,000 | 137.12 ns | 116.57 ns | 106.05 ns | 4.14 µs (35.50x slower) | 3.95 µs (33.89x slower) |
