...
later branch commits contain reports, preserved evidence, and PR linkage only.
The validation branch is synchronized with origin. PR #24 is a Draft evidence
